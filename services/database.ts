...
export const createFreightCalculation = async (calc: FreightCalculation): Promise<FreightCalculation | null> => {
    const dbRecord = {
        ...
        base_freight: calc.baseFreight,
        tolls: calc.tolls,
        extra_costs: calc.extraCosts || 0,
        extra_costs_description: calc.extraCostsDescription || null,
        goods_value: calc.goodsValue,
        insurance_percent: calc.insurancePercent,
        ad_valorem: calc.adValorem,
        profit_margin: calc.profitMargin,
        icms_percent: calc.icmsPercent,
        pis_percent: calc.pisPercent,
        cofins_percent: calc.cofinsPercent,
