...
const mapFreightRow = (item: any): FreightCalculation => ({
        ...
        icmsManual: item.icms_manual ?? false,
        pagadorMg: item.pagador_mg ?? false,
        ...
        pipefyCardUrl: item.pipefy_card_url || undefined,
...
export const createFreightCalculation = async (calc: FreightCalculation): Promise<{ success: boolean; data?: FreightCalculation; error?: string; duplicate?: boolean }> => {
    ...
    const dbRecord = {
        ...
        icms_manual: calc.icmsManual ?? false,
        pagador_mg: calc.pagadorMg ?? false,
...
export const updateFreightCalculation = async (calc: FreightCalculation): Promise<{ success: boolean; error?: string }> => {
    ...
    const dbRecord = {
        ...
        pipefy_card_url: calc.pipefyCardUrl || null,
