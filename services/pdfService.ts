...
export const generateHiringPDF = (data: FreightCalculation) => {
    ...
    autoTable(doc, {
        ...
        body: [
            ...
            ['Marca / Modelo', `${data.placaCavaloMarca || ''} ${data.placaCavaloModelo || ''}`.trim() || 'N/A'],
    ...
    if (data.placaCarreta1) {
        autoTable(doc, {
            ...
            body: [
                ...
                ['Marca / Modelo', `${data.placaCarreta1Marca || ''} ${data.placaCarreta1Modelo || ''}`.trim() || 'N/A'],
    ...
    if (data.placaCarreta2) {
        autoTable(doc, {
            ...
            body: [
                ...
                ['Marca / Modelo', `${data.placaCarreta2Marca || ''} ${data.placaCarreta2Modelo || ''}`.trim() || 'N/A'],
